...
router.patch("/api/v1/job_type_tags/:id", jsonParser, (0, _expressValidator.body)(_db.JobTypeTagField.title).isString(), (0, _expressValidator.body)(_db.JobTypeTagField.notes).isString().optional(), /*#__PURE__*/function () {
